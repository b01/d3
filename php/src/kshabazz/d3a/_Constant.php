...
define( 'kshabazz\\d3a\\IMG_DIR', ROOT . '/media/images' );
...
define( 'kshabazz\\d3a\\BATTLENET_D3_API_ITEM_URL', 'http://us.battle.net/api/d3/data/%s' );
...
define( 'kshabazz\\d3a\\ATTRIBUTE_MAP_FILE', ROOT . '/media/data-files/attribute-map.txt' );
